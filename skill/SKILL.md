---
name: tt-shaduni-skill
description: TT ShadUni 小程序开发 Skill。Vue3 + UniApp + EMAS 技术栈，tt-shaduni 组件库（shadcn/ui 风格）。查询组件API/架构模式/主题系统，或从需求生成完整模块代码（Schema/API/Store/页面/路由）。适用于 tt-button tt-cell tt-calendar 等 63 个组件，微信/支付宝小程序开发。
tags:
- uniapp
- vue3
- miniprogram
